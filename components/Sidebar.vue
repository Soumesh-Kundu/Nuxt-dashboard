<template>
  ...
  >
    <div class="h-full px-3 py-4 overflow-y-auto bg-[#111827]">
      <div
        class="flex items-center justify-center w-full my-3 text-4xl font-bold text-white"
      >
        Qualyval
      </div>
        ...
        <li>
          ...
          >
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              class="flex-shrink-0 w-6 h-6 text-gray-400 transition duration-75 group-hover group-hover:text-white"
            >
              <path
            ...
            <span class="flex-1 ml-3 whitespace-nowrap">Calender & Todos</span>
          </NuxtLink>
        </li>
      </ul>
      <h3 class="mt-6 mb-3 text-gray-400">RECRUITMENT</h3>
      <ul class="space-y-2 font-normal">
        <li>
          <NuxtLink
            to="/jobs"
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ml-3 whitespace-nowrap">My Referrals</span>
          </NuxtLink>
        </li>
        <li>
          <NuxtLink
          ...
          >
            ...
            <span class="flex-1 ml-3 whitespace-nowrap">Career Site</span>
          </NuxtLink>
        </li>
      </ul>
      <h3 class="mt-6 mb-3 text-gray-400">ORGANIZATION</h3>
      <ul class="space-y-2 font-normal">
        <li>
          <NuxtLink
            to=""
